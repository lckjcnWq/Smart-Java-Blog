...
public class LinkController {
    ...
    @ApiOperation(value = "友链查询", notes = "用于友链查询")
     ...
     * 友链添加
     */
    @ApiOperation(value = "友链添加", notes = "用于友链添加")
    @ApiImplicitParams(
            {
                    @ApiImplicitParam(name = "linkType",dataType = "Integer",value = "友链类型",paramType = "query",required = true),
                    @ApiImplicitParam(name = "linkName",dataType = "String",value = "友链名称",paramType = "query",required = true),
                    @ApiImplicitParam(name = "linkUrl",dataType = "String",value = "友链Url",paramType = "query",required = true),
                    @ApiImplicitParam(name = "linkRank",dataType = "Integer",value = "友链排名",paramType = "query",required = true),
                    @ApiImplicitParam(name = "linkDescription",dataType = "String",value = "友链描述",paramType = "query",required = true)
            }
    )
     ...
     * 详情
     */
    @ApiOperation(value = "详情", notes = "友链详情")
    @ApiImplicitParam(name = "id",dataType = "Integer",value = "友链id",paramType = "path",required = true)
     ...
     * 友链修改
     */
    @ApiOperation(value = "友链修改", notes = "用于友链修改")
    @ApiImplicitParams(
            {
                    @ApiImplicitParam(name = "linkType",dataType = "Integer",value = "友链类型",paramType = "query",required = true),
                    @ApiImplicitParam(name = "linkName",dataType = "String",value = "友链名称",paramType = "query",required = true),
     ...
     * 友链删除
     */
    @ApiOperation(value = "友链删除", notes = "用于友链删除")
